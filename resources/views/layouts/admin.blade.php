...
<aside class="sidebar">
    ...
    <nav class="sb-nav">
        ...
        <div class="sb-sec">Kelola Konten</div>
        <a href="{{ route('admin.artikel.index') }}"
           class="sb-link {{ request()->routeIs('admin.artikel.*') ? 'active' : '' }}">
            <span class="sb-icon">📝</span> Artikel Jurusan
        </a>
        <a href="{{ route('admin.infojurusan.index') }}"
           class="sb-link {{ request()->routeIs('admin.infojurusan.*') ? 'active' : '' }}">
            <span class="sb-icon">📋</span> Informasi Jurusan
        </a>
