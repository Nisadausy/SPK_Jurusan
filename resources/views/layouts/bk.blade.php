...
<aside class="bk-sidebar" id="bk-sidebar">
    ...
    <nav class="sb-nav">
        ...
        <a href="{{ route('bk.dashboard') }}"         class="sb-item {{ request()->routeIs('bk.dashboard')      ? 'active':'' }}"><span class="sb-icon">🏠</span> Dashboard</a>
        <a href="{{ route('bk.siswa.index') }}"       class="sb-item {{ request()->routeIs('bk.siswa.*')        ? 'active':'' }}"><span class="sb-icon">👨‍🎓</span> Data Siswa</a>
        <a href="{{ route('bk.statistik') }}"         class="sb-item {{ request()->routeIs('bk.statistik')      ? 'active':'' }}"><span class="sb-icon">📊</span> Statistik Jurusan</a>
        <div class="sb-section">Konten</div>
        <a href="{{ route('bk.artikel.index') }}"     class="sb-item {{ request()->routeIs('bk.artikel.*')      ? 'active':'' }}"><span class="sb-icon">📝</span> Artikel Jurusan</a>
        <a href="{{ route('bk.infojurusan.index') }}" class="sb-item {{ request()->routeIs('bk.infojurusan.*')  ? 'active':'' }}"><span class="sb-icon">🏫</span> Info Jurusan</a>
        <div class="sb-section">Akun</div>
        <a href="{{ route('bk.profil') }}"            class="sb-item {{ request()->routeIs('bk.profil')         ? 'active':'' }}"><span class="sb-icon">👤</span> Profil Saya</a>
        <a href="{{ route('bk.password.index') }}"    class="sb-item {{ request()->routeIs('bk.password.*')     ? 'active':'' }}"><span class="sb-icon">🔒</span> Ubah Password</a>
    </nav>
    <div class="sb-user">
