    ...
    <table style="width:100%;border-collapse:collapse;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #e2e8f0;" onmouseover="this.style.background='#fafbfc'" onmouseout="this.style.background=''">
                ...
                <td style="padding:12px 16px;">
                    @if($guru->jurusan)
                        <span style="background:#eff6ff;color:#2563eb;border:1px solid #bfdbfe;padding:3px 9px;border-radius:100px;font-size:10.5px;font-weight:700;">{{ $guru->jurusan->nama }}</span>
                    @else
