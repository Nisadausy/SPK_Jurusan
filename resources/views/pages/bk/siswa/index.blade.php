    ...
    <table>
        ...
        <tbody>
            ...
            @php
                ...
                $rek     = $lastTes?->rekomendasiTeratas?->jurusan?->nama;
                $m1      = $lastTes?->minatJurusan1?->nama;
                $m2      = $lastTes?->minatJurusan2?->nama;
                $sesuai  = $lastTes && $lastTes->rekomendasiTeratas && $lastTes->rekomendasiTeratas->jurusan_id === $lastTes->minat_jurusan_1_id;
            @endphp
            <tr>
                ...
                <td>
                    @if($rek) <span class="badge badge-blue">{{ $rek }}</span>
                    @else <span class="badge badge-gray">Belum tes</span>
                    @endif
                </td>
