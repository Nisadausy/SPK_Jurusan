                ...
                <form method="POST" action="{{ route('siswa.profile.update') }}">
                    ...
                    <div class="fgrid full">
                        <div class="field">
                            ...
                            <div class="radio-grp">
                                @php $gv = old('jenis_kelamin', $siswa->jenis_kelamin ?? ''); @endphp
                                <label class="radio-card {{ $gv==='L' ? 'sel' : '' }}" onclick="selG(this)">
                                    <input type="radio" name="jenis_kelamin" value="L" disabled {{ $gv==='L' ? 'checked' : '' }}/>
                                    <span>👦 Laki-laki</span>
                                </label>
                                <label class="radio-card {{ $gv==='P' ? 'sel' : '' }}" onclick="selG(this)">
                                    <input type="radio" name="jenis_kelamin" value="P" disabled {{ $gv==='P' ? 'checked' : '' }}/>
                                    <span>👧 Perempuan</span>
                                </label>
                            </div>
                        </div>
