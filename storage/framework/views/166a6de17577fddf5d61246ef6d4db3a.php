...
<?php $__env->startSection('title', 'Tes SPK - SMK Negeri 2 Jember'); ?>
...
<div class="spk-wrapper">
    ...
    <div class="spk-container">
        ...
        <?php endif; ?>
        <?php if(session('info')): ?>
        <div class="alert-box alert-info">ℹ️ <?php echo e(session('info')); ?></div>
        <?php endif; ?>
        ...
        <form id="spkForm" method="POST" action="<?php echo e(route('siswa.tes.simpan')); ?>" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div class="step-panel active" id="step-0">
                ...
                <div class="card-body">
                    ...
                    <div class="field" style="margin-bottom:20px">
                        ...
                        <select name="jurusan_pilihan_1" id="jurusan_pilihan_1" required>
                            ...
                            <option value="<?php echo e($j->id); ?>" <?php echo e(old('jurusan_pilihan_1') == $j->id ? 'selected' : ''); ?>><?php echo e($j->nama_jurusan); ?></option>
                    ...
                    <div class="field" style="margin-bottom:20px">
                        ...
                        <select name="jurusan_pilihan_2" id="jurusan_pilihan_2" required>
                            <option value="">-- Pilih Jurusan --</option>
                            <?php $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($j->id); ?>" <?php echo e(old('jurusan_pilihan_2') == $j->id ? 'selected' : ''); ?>><?php echo e($j->nama_jurusan); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
            ...
            <div class="btn-nav">
                <a href="<?php echo e(url('/')); ?>" class="btn-prev">🏠 Kembali ke Home</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-grid">
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                <input type="number" name="tinggi_badan" id="tinggi_badan" class="has-unit" placeholder="165" min="100" max="220" value="<?php echo e(old('tinggi_badan')); ?>" />
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                <input type="number" name="berat_badan" id="berat_badan" class="has-unit" placeholder="55" min="20" max="200" value="<?php echo e(old('berat_badan')); ?>" />
                    ...
                    <div class="field" style="margin-bottom:18px">
                        ...
                        <input type="hidden" name="buta_warna" id="buta_warna" value="<?php echo e(old('buta_warna')); ?>" />
                    </div>
                </div>
            </div>
            <div class="btn-nav">
                ...
                <div class="card-body">
                    ...
                    <div class="nilai-grid">
                        <div class="nilai-card">
                            ...
                            <input type="number" name="nilai_matematika" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_matematika')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                        <div class="nilai-card">
                            <div class="nilai-label">Bahasa Indonesia</div>
                            <input type="number" name="nilai_bahasa_indonesia" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_bahasa_indonesia')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                        <div class="nilai-card">
                            <div class="nilai-label">Bahasa Inggris</div>
                            <input type="number" name="nilai_bahasa_inggris" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_bahasa_inggris')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                        <div class="nilai-card">
                            <div class="nilai-label">IPA</div>
                            <input type="number" name="nilai_ipa" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_ipa')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                        <div class="nilai-card">
                            <div class="nilai-label">IPS</div>
                            <input type="number" name="nilai_ips" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_ips')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                        <div class="nilai-card">
                            <div class="nilai-label">Fisika</div>
                            <input type="number" name="nilai_fisika" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_fisika')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                        <div class="nilai-card">
                            <div class="nilai-label">Biologi</div>
                            <input type="number" name="nilai_biologi" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_biologi')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                        
                        <div class="nilai-card">
                            <div class="nilai-label">PPKN</div>
                            <input type="number" name="nilai_ppkn" class="nilai-input" placeholder="85" min="0" max="100" value="<?php echo e(old('nilai_ppkn')); ?>" />
                            <div class="nilai-scale">0 – 100</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if($soal->count() > 0): ?>
                        ...
                        <div class="bakat-question <?php echo e(old('bakat_q'.($i+1)) ? 'answered' : ''); ?>" id="bq_<?php echo e($i+1); ?>">

                            <div class="bakat-q-num">
                                Pertanyaan <?php echo e($i+1); ?>
                            ...
                            <div class="bakat-options">
                                <?php $__currentLoopData = $opsiJawaban; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="bakat-opt <?php echo e(old('bakat_q'.($i+1))==$val ? 'selected' : ''); ?>"
                                    onclick="pilihBakat(this,<?php echo e($i+1); ?>)">

                                    <input type="radio"
                                        name="bakat_q<?php echo e($i+1); ?>"
                                        value="<?php echo e($val); ?>"
                                        <?php echo e(old('bakat_q'.($i+1))==$val ? 'checked' : ''); ?> />
...
<script>
    ...
    const oldButa='<?php echo e(old("buta_warna")); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/siswa/tes.blade.php ENDPATH**/ ?>