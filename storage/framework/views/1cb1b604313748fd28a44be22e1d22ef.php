...
<?php $__env->startSection('title', 'Hasil Tes SPK - SMK Negeri 2 Jember'); ?>
...
<div class="hasil-wrapper">
    ...
    <div class="hasil-container">
        ...
        <div class="result-hero">
            <div class="result-hero-icon"><?php echo e($ikon); ?></div>
            <div class="result-hero-rank">🏆 Rekomendasi #1 Untukmu</div>
            <div class="result-hero-name"><?php echo e($rekomendasi->jurusan->nama_jurusan ?? '-'); ?></div>
            <div class="result-hero-score">⭐ Skor SAW: <?php echo e(number_format($rekomendasi->nilai_preferensi * 100, 2)); ?>%</div>
            <p class="result-hero-sub">Halo <strong style="color:var(--text)"><?php echo e($namaField); ?></strong>, berdasarkan nilai akademik dan minat bakat kamu, jurusan ini paling sesuai untukmu.</p>
        </div>

        
        <?php if(isset($jurusanPilihan1) && isset($jurusanPilihan2) && $jurusanPilihan1 && $jurusanPilihan2): ?>
        <?php
        ...
        <div class="comparison-section">
            ...
            <div class="compare-grid">
                ...
                <div class="compare-card j1 <?php echo e($winner===1 ? 'winner' : ''); ?>">
                    <div class="compare-icon"><?php echo e($ikon1); ?></div>
                    <div class="compare-tag">Pilihan 1</div>
                    <div class="compare-name"><?php echo e($jurusanPilihan1->nama_jurusan); ?></div>
                    <?php if($skorPilihan1): ?>
                    <div class="compare-score-wrap">
                        <div class="compare-score-num"><?php echo e(number_format($skor1*100,2)); ?>%</div>
                        <div class="compare-score-label">Skor Kesesuaian SAW</div>
                    </div>
                    <div class="compare-bar-wrap"><div class="compare-bar-fill" style="width:0%" data-target="<?php echo e($bar1); ?>%"></div></div>
                    <div class="compare-rank">🏅 Peringkat #<?php echo e($skorPilihan1->peringkat); ?></div>
                    <?php else: ?>
                ...
                <div class="compare-card j2 <?php echo e($winner===2 ? 'winner' : ''); ?>">
                    <div class="compare-icon"><?php echo e($ikon2); ?></div>
                    <div class="compare-tag">Pilihan 2</div>
                    <div class="compare-name"><?php echo e($jurusanPilihan2->nama_jurusan); ?></div>
                    <?php if($skorPilihan2): ?>
                    <div class="compare-score-wrap">
                        <div class="compare-score-num"><?php echo e(number_format($skor2*100,2)); ?>%</div>
                        <div class="compare-score-label">Skor Kesesuaian SAW</div>
                    </div>
                    <div class="compare-bar-wrap"><div class="compare-bar-fill" style="width:0%" data-target="<?php echo e($bar2); ?>%"></div></div>
                    <div class="compare-rank">🏅 Peringkat #<?php echo e($skorPilihan2->peringkat); ?></div>
                    <?php else: ?>
                    <div style="font-size:12px;color:var(--text-dim);margin-top:10px">ℹ️ Tidak masuk perhitungan SAW</div>
                    <?php endif; ?>
                </div>
            ...
            <div class="verdict-box">
                ...
                <div style="font-size:14px;font-weight:700;color:var(--green)">
                    ✅ <strong style="color:var(--accent)"><?php echo e($jurusanPilihan1->nama_jurusan); ?></strong> lebih sesuai dengan profil kamu
                    <span style="color:var(--text-dim);font-weight:400">(selisih <?php echo e(number_format(abs($skor1-$skor2)*100,2)); ?>%)</span>
                </div>
                <?php elseif($winner===2): ?>
                <div style="font-size:14px;font-weight:700;color:var(--green)">
                    ✅ <strong style="color:var(--accent2)"><?php echo e($jurusanPilihan2->nama_jurusan); ?></strong> lebih sesuai dengan profil kamu
                    <span style="color:var(--text-dim);font-weight:400">(selisih <?php echo e(number_format(abs($skor1-$skor2)*100,2)); ?>%)</span>
                </div>
                <?php else: ?>
        ...
        <div class="info-card">
            ...
            <div class="grid-4x2">
                <div class="info-item">
                    ...
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_matematika); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">Bhs. Indonesia</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_bahasa_indonesia); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">Bhs. Inggris</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_bahasa_inggris); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">IPA</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_ipa); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">IPS</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_ips); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">Fisika</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_fisika); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">Biologi</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_biologi); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">PPKN</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->nilai_ppkn); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="info-card">
            ...
            <div class="grid-3col">
                <div class="info-item">
                    ...
                    <div class="info-item-value">
                        <?php echo e($tesTerakhir->tinggi_badan); ?>
                ...
                <div class="info-item">
                    ...
                    <div class="info-item-value">
                        <?php echo e($tesTerakhir->berat_badan); ?>
                ...
                <div class="info-item">
                    ...
                    <div class="info-item-value <?php echo e($bmiClass); ?>"><?php echo e($bmi); ?></div>
                    <div class="info-item-sub <?php echo e($bmiClass); ?>"><?php echo e($bmiKategori); ?></div>
                </div>
            </div>
            ...
            <div class="grid-meta">
                <div class="info-item">
                    ...
                    <div class="info-item-value" style="color:<?php echo e($tesTerakhir->buta_warna ? '#e05454' : 'var(--green)'); ?>">
                        <?php echo e($tesTerakhir->buta_warna ? '🔴 Ya' : '🟢 Tidak'); ?>
                ...
                <div class="info-item">
                    ...
                    <div class="info-item-value" style="color:var(--accent)">
                        <?php echo e($tesTerakhir->skor_minat_bakat); ?>%
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-item-label">Tanggal Tes</div>
                    <div class="info-item-value"><?php echo e($tesTerakhir->created_at->format('d M Y')); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="ranking-card">
            ...
            ?>
            <?php $__currentLoopData = $hasilList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $hasil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                ...
                $barWidth  = $topScore > 0
                    ...
                    : '0';
            ?>
            <div class="rank-item <?php echo e($rankClass); ?> <?php echo e((!$rankClass && $isPilihan) ? 'pilihan' : ''); ?>">
                <div class="rank-num"><?php echo e($hasil->peringkat); ?></div>
                <div class="rank-info">
                    <div class="rank-nama">
                        <?php echo e($hasil->jurusan->nama_jurusan ?? '-'); ?>

                        <?php if($isPilihan): ?><span class="rank-badge">✓ Pilihanmu</span><?php endif; ?>
                    </div>
                    <div class="rank-bar-wrap">
                        <div class="rank-bar-fill" style="width:0%" data-target="<?php echo e($barWidth); ?>%"></div>
                    </div>
                </div>
                <div class="rank-score"><?php echo e($pct); ?>%</div>
            </div>
        ...
        <div class="saw-card">
            ...
            <div class="table-wrap">
                <table class="saw-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $hasilList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $hasil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="<?php echo e($i===0 ? 'best' : ''); ?>">
                            <td><?php echo e($hasil->peringkat); ?></td>
                            <td><?php echo e($hasil->jurusan->nama_jurusan ?? '-'); ?></td>
                            <td class="score-col"><?php echo e(number_format($hasil->nilai_preferensi, 6)); ?></td>
                            <td><strong><?php echo e(number_format($hasil->nilai_preferensi * 100, 2)); ?>%</strong></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
        ...
        <div class="btn-group">
            <a href="<?php echo e(url('/')); ?>" class="btn btn-ghost">🏠 Kembali ke Home</a>
            <a href="<?php echo e(route('siswa.tes.index')); ?>" class="btn btn-ghost">🔄 Ulangi Tes</a>
            <a href="<?php echo e(route('siswa.tes.cetak')); ?>" class="btn btn-pdf" target="_blank">📄 Cetak / Download PDF</a>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/siswa/hasil.blade.php ENDPATH**/ ?>