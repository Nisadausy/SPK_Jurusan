...
<head>
    ...
    <title>Hasil SPK - <?php echo e($namaSiswa); ?></title>
...
<div class="pdf-wrapper">
    ...
    <div class="info-grid grid-3" style="margin-bottom:10px">
        <div class="info-item">
            ...
            <div class="info-item-value"><?php echo e($namaSiswa); ?></div>
        </div>
        <div class="info-item">
            <div class="info-item-label">Tanggal Tes</div>
            <div class="info-item-value"><?php echo e(optional($tesTerakhir->created_at)->format('d M Y') ?? '-'); ?></div>
        </div>
        <div class="info-item">
            <div class="info-item-label">Skor Minat Bakat</div>
            <div class="info-item-value"><?php echo e($tesTerakhir->skor_minat_bakat); ?>%</div>
        </div>
    </div>
    ...
    <div class="info-grid grid-4">
        ...
        <div class="info-item">
            ...
            <div class="info-item-value"><?php echo e($bmi); ?></div>
            <div class="info-item-sub"><?php echo e($bmiKategori); ?></div>
        </div>
        <div class="info-item">
            <div class="info-item-label">Buta Warna</div>
            <div class="info-item-value" style="color:<?php echo e($tesTerakhir->buta_warna ? '#c0392b' : '#27ae60'); ?>">
    ...
    <?php $rekomendasi = $hasilList->first(); ?>

    <div class="section-title">Rekomendasi Jurusan</div>
    <?php if($rekomendasi): ?>
        <?php $skorRek = max(0, min(100, ($rekomendasi->nilai_preferensi ?? 0) * 100)); ?>
        <div class="rec-box">
            <div class="rec-label">🏆 Jurusan Terbaik Untukmu</div>
            <div class="rec-name"><?php echo e($rekomendasi->jurusan->nama_jurusan ?? '-'); ?></div>
            <div class="rec-score">Nilai Preferensi SAW Tertinggi</div>
            <div class="rec-badge">Skor: <?php echo e(number_format($skorRek, 2)); ?>%</div>
        </div>
    <?php else: ?>
        <div class="rec-box">
    ...
    <?php $maxNilai = $hasilList->max('nilai_preferensi') ?? 0; ?>
    <table class="ranking-table">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $hasilList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $hasil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    $rankClass = $i === 0 ? 'best' : '';
                ...
                ?>
                <tr class="<?php echo e($rankClass); ?>">
                    <td style="text-align:center">
                        <span class="rank-num <?php echo e($numClass); ?>"><?php echo e($hasil->peringkat ?? ($i+1)); ?></span>
                    </td>
                    <td><?php echo e($hasil->jurusan->nama_jurusan ?? '-'); ?></td>
                    <td>
                        <div class="bar-wrap">
                            <div class="bar-fill" style="width:<?php echo e($barPct); ?>%"></div>
                        </div>
                        <?php echo e(number_format($skorPct, 2)); ?>%
                    </td>
                    <td style="font-weight:700"><?php echo e(number_format($nilai, 6)); ?></td>
                    <td style="font-weight:800;color:<?php echo e($i===0 ? '#7c5c10' : '#374151'); ?>">
                        <?php echo e(number_format($skorPct, 2)); ?>%
                    </td>
                </tr>
    ...
    <div class="pdf-footer">
        ...
        <span>Dicetak: <?php echo e(now()->format('d F Y, H:i')); ?> WIB</span>
    </div>

</div>
</body>
</html><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/siswa/hasil-pdf.blade.php ENDPATH**/ ?>