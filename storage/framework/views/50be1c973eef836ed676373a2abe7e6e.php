...
<?php $__env->startSection('title', 'History Tes - SMK Negeri 2 Jember'); ?>
...
<div class="history-wrapper">
    <div class="history-container">
        ...
        <a href="<?php echo e(route('landingpage')); ?>" class="btn-back">← Kembali ke Dashboard</a>
        ...
        <div class="card">
            <?php if($histories->isEmpty()): ?>
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('siswa.tes.index')); ?>" class="btn-primary">🎯 Mulai Tes Sekarang</a>
                </div>
            <?php else: ?>
                <div class="card-header">
                    <h3>Riwayat Tes Kamu</h3>
                    <p>Total <?php echo e($histories->total()); ?> kali tes</p>
                </div>
                ...
                <div style="overflow-x:auto">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <tr>
                                    <td style="color:var(--text-dim)">
                                        <?php echo e($histories->firstItem() + $index); ?>

                                    </td>

                                    <td>
                                        <?php echo e($tes->created_at->format('d M Y')); ?>

                                        <span style="display:block;font-size:11px;color:var(--text-dim)">
                                            <?php echo e($tes->created_at->format('H:i')); ?> WIB
                                        </span>
                                    </td>

                                    <td>
                                        <?php if($top && $top->jurusan): ?>
                                            <span class="badge-jurusan">
                                                🏆 <?php echo e($top->jurusan->nama_jurusan); ?>
                                    ...
                                    <td><?php echo e($top ? number_format($top->nilai_preferensi, 4) : '-'); ?></td>
                                    <td><?php echo e($top ? '#'.$top->peringkat : '-'); ?></td>

                                    <td>
                                        <div class="aksi-wrap">
                                            <a href="<?php echo e(route('siswa.tes.hasil.show', $tes->id)); ?>"
                                               class="btn-action btn-view">
                                                👁️ Lihat Hasil
                                            </a>

                                            <a href="<?php echo e(route('siswa.tes.pdf.download', $tes->id)); ?>"
                                               class="btn-action btn-pdf <?php echo e($pdfReady ? '' : 'btn-disabled'); ?>"
                                               title="<?php echo e($pdfReady ? 'Download PDF' : 'PDF belum tersedia'); ?>">
                                                📄 Download PDF
                                            </a>
                                        </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/siswa/history.blade.php ENDPATH**/ ?>