...
<?php $title = 'Profil Saya - SMK Negeri 2 Jember'; ?>
...
<div class="back-bar">
    <a href="<?php echo e(route('landing.home')); ?>" class="back-btn-top">
        ← Kembali ke Beranda
    </a>
...
<div class="pc">
    ...
    <div class="hero-card">
        <div class="hero-inner">
            ...
            <div class="hero-info">
                <div class="hero-name"><?php echo e($namaUser); ?></div>
                <div class="hero-email"><?php echo e($emailUser); ?></div>
                <div class="hero-badges">
                    <span class="hbadge hb-grn">🎓 Siswa Aktif</span>
                    <?php if($genderLabel): ?>
                        <span class="hbadge hb-gld"><?php echo e($genderLabel); ?></span>
                    <?php endif; ?>
                    <?php if($sekolah): ?>
                        <span class="hbadge hb-blu">🏫 <?php echo e($sekolah); ?></span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="tab-btns">
    ...
    <div class="tab-panel active" id="tab-lihat">
        <div class="data-grid">
            <div class="data-item">
                ...
                <div><div class="d-lbl">Nama Lengkap</div><div class="d-val"><?php echo e(Auth::user()->nama ?? '-'); ?></div></div>
            </div>
            <div class="data-item">
                <div class="d-icon ic-blu">✉️</div>
                <div><div class="d-lbl">Email</div><div class="d-val"><?php echo e(Auth::user()->email ?? '-'); ?></div></div>
            </div>
            <div class="data-item">
                <div class="d-icon ic-grn">📞</div>
                <div><div class="d-lbl">No. Telepon</div><div class="d-val <?php echo e(!$siswa->no_telepon ? 'na' : ''); ?>"><?php echo e($siswa->no_telepon ?? 'Belum diisi'); ?></div></div>
            </div>
            <div class="data-item">
                <div class="d-icon ic-org">🏫</div>
                <div><div class="d-lbl">Sekolah Asal</div><div class="d-val <?php echo e(!$siswa->sekolah_asal ? 'na' : ''); ?>"><?php echo e($siswa->sekolah_asal ?? 'Belum diisi'); ?></div></div>
            </div>
            <div class="data-item full">
                <div class="d-icon ic-pur">⚧️</div>
                <div><div class="d-lbl">Jenis Kelamin</div>
                <div class="d-val <?php echo e(!$siswa->jenis_kelamin ? 'na' : ''); ?>">
                    <?php if($siswa->jenis_kelamin === 'L'): ?> 👦 Laki-laki
                    <?php elseif($siswa->jenis_kelamin === 'P'): ?> 👧 Perempuan
                    <?php else: ?> Belum diisi
                    <?php endif; ?>
                </div></div>
            </div>
        </div>
        <div style="display:flex;gap:10px;justify-content:flex-end;">
            <a href="<?php echo e(route('landing.home')); ?>" class="btn-back">🏠 Kembali ke Beranda</a>
    ...
    <div class="tab-panel" id="tab-edit">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('siswa.profile.update')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="fgrid">
                        <div class="field">
                            ...
                            <input type="text" name="nama" value="<?php echo e(old('nama', Auth::user()->nama)); ?>" placeholder="Nama lengkap kamu" required/>
                        </div>
                        <div class="field">
                            <label>Email <span class="req">*</span></label>
                            <input type="email" name="email" value="<?php echo e(old('email', Auth::user()->email)); ?>" placeholder="email@contoh.com" required/>
                        </div>
                    </div>
                    ...
                    <div class="fgrid">
                        <div class="field">
                            ...
                            <input type="text" name="no_telepon" value="<?php echo e(old('no_telepon', $siswa->no_telepon ?? '')); ?>" placeholder="08xxxxxxxxxx"/>
                        </div>
                        <div class="field">
                            <label>Sekolah Asal</label>
                            <input type="text" name="sekolah_asal" value="<?php echo e(old('sekolah_asal', $siswa->sekolah_asal ?? '')); ?>" placeholder="Nama SMP/sekolah asal kamu"/>
                        </div>
                    </div>
                    <div class="fgrid full">
                        <div class="field">
                            ...
                            <div class="radio-grp">
                                <?php $gv = old('jenis_kelamin', $siswa->jenis_kelamin ?? ''); ?>
                                <label class="radio-card <?php echo e($gv==='L' ? 'sel' : ''); ?>" onclick="selG(this)">
                                    <input type="radio" name="jenis_kelamin" value="L" disabled <?php echo e($gv==='L' ? 'checked' : ''); ?>/>
                                    <span>👦 Laki-laki</span>
                                </label>
                                <label class="radio-card <?php echo e($gv==='P' ? 'sel' : ''); ?>" onclick="selG(this)">
                                    <input type="radio" name="jenis_kelamin" value="P" disabled <?php echo e($gv==='P' ? 'checked' : ''); ?>/>
                                    <span>👧 Perempuan</span>
                                </label>
                            </div>
                        </div>
    ...
    <div class="tab-panel" id="tab-pass">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('siswa.profile.password')); ?>" id="pwdForm">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/siswa/profile.blade.php ENDPATH**/ ?>