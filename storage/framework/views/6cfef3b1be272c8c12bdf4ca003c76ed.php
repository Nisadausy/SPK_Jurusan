<footer id="kontak" class="footer text-white pt-12 pb-6">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs text-blue-200">
                    <li><a href="<?php echo e(route('landing.home')); ?>#profil" class="hover:text-white transition-colors">Profil Sekolah</a></li>
                    <li><a href="<?php echo e(route('landing.home')); ?>#visi-misi" class="hover:text-white transition-colors">Visi & Misi</a></li>
                    <li><a href="<?php echo e(route('landing.home')); ?>#struktur" class="hover:text-white transition-colors">Struktur Organisasi</a></li>
                    <li><a href="<?php echo e(route('landing.home')); ?>#tenaga-pendidik" class="hover:text-white transition-colors">Tenaga Pendidik</a></li>
                    <li><a href="<?php echo e(route('landing.home')); ?>#fasilitas" class="hover:text-white transition-colors">Fasilitas Sekolah</a></li>
                    <li><a href="<?php echo e(route('landing.home')); ?>#prestasi" class="hover:text-white transition-colors">Prestasi</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs text-blue-200">
                    ...
                    <li><a href="<?php echo e(route('landing.home')); ?>#bursa-kerja" class="hover:text-white transition-colors">Bursa Kerja Khusus</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-white/10 pt-5 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-blue-300">
            <span>© <?php echo e(date('Y')); ?> SMK Negeri 2 Jember. All Rights Reserved.</span>
            <span>Powered by <a href="<?php echo e(route('landing.home')); ?>" class="text-amber-300 hover:underline">Sistem SPK Pemilihan Jurusan</a></span>
        </div>
    </div>
</footer><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/partials/footer-landing.blade.php ENDPATH**/ ?>