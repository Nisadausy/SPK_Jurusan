        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-row">
                <div class="form-group full">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nama sesuai rapor" required autofocus>
                </div>

                <div class="form-group full">
                    <label>Email</label>
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="email@gmail.com" required>
                </div>
                ...
                <div class="form-group full">
                    ...
                    <input type="text" name="sekolah_asal" value="<?php echo e(old('sekolah_asal')); ?>" placeholder="Contoh: SMP Negeri 1 Jember">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="no_telepon" value="<?php echo e(old('no_telepon')); ?>" placeholder="08xxxxxxxxxx">
                </div>

                <div class="form-group full">
                    <label>Alamat</label>
                    <textarea name="alamat" placeholder="Alamat lengkap kamu..."><?php echo e(old('alamat')); ?></textarea>
                </div>
            </div>

            <button type="submit" class="btn-register">Daftar Sekarang →</button>

            <div class="login-link">Sudah punya akun? <a href="<?php echo e(route('login')); ?>">Masuk</a></div>
        </form>
    </div>
</div>

</body>
</html><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/auth/register.blade.php ENDPATH**/ ?>