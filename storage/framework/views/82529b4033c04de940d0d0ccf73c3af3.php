...
<title><?php echo $__env->yieldContent('title','Dashboard'); ?> — BK SMK Negeri 2 Jember</title>
...
<aside class="bk-sidebar" id="bk-sidebar">
    ...
    <nav class="sb-nav">
        ...
        <a href="<?php echo e(route('bk.dashboard')); ?>"         class="sb-item <?php echo e(request()->routeIs('bk.dashboard')      ? 'active':''); ?>"><span class="sb-icon">🏠</span> Dashboard</a>
        <a href="<?php echo e(route('bk.siswa.index')); ?>"       class="sb-item <?php echo e(request()->routeIs('bk.siswa.*')        ? 'active':''); ?>"><span class="sb-icon">👨‍🎓</span> Data Siswa</a>
        <a href="<?php echo e(route('bk.statistik')); ?>"         class="sb-item <?php echo e(request()->routeIs('bk.statistik')      ? 'active':''); ?>"><span class="sb-icon">📊</span> Statistik Jurusan</a>
        <div class="sb-section">Konten</div>
        <a href="<?php echo e(route('bk.artikel.index')); ?>"     class="sb-item <?php echo e(request()->routeIs('bk.artikel.*')      ? 'active':''); ?>"><span class="sb-icon">📝</span> Artikel Jurusan</a>
        <a href="<?php echo e(route('bk.infojurusan.index')); ?>" class="sb-item <?php echo e(request()->routeIs('bk.infojurusan.*')  ? 'active':''); ?>"><span class="sb-icon">🏫</span> Info Jurusan</a>
        <div class="sb-section">Akun</div>
        <a href="<?php echo e(route('bk.profil')); ?>"            class="sb-item <?php echo e(request()->routeIs('bk.profil')         ? 'active':''); ?>"><span class="sb-icon">👤</span> Profil Saya</a>
        <a href="<?php echo e(route('bk.password.index')); ?>"    class="sb-item <?php echo e(request()->routeIs('bk.password.*')     ? 'active':''); ?>"><span class="sb-icon">🔒</span> Ubah Password</a>
    </nav>
    <div class="sb-user">
        <div class="sb-avatar"><?php echo e(strtoupper(substr(Auth::user()->nama, 0, 1))); ?></div>
        <div>
            <div class="sb-uname"><?php echo e(Auth::user()->nama); ?></div>
            <div class="sb-unip"><?php echo e(Auth::user()->guruBk->nip ?? 'Guru BK'); ?></div>
        </div>
...
<div class="bk-main">
    <div class="bk-topbar">
        <div>
            ...
            <div class="tb-sub"><?php echo $__env->yieldContent('page-sub',''); ?></div>
        </div>
        <div class="tb-date"><?php echo e(now()->translatedFormat('l, d F Y')); ?></div>
    </div>
            ...
            <div class="alert alert-danger">
                <div><strong>⚠ Perbaiki:</strong>
                    <ul style="padding-left:16px;margin-top:4px;">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li style="font-size:12px;"><?php echo e($e); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            </div>
        <?php endif; ?>
...
</html><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/layouts/bk.blade.php ENDPATH**/ ?>