...
<title><?php echo e($jurusan->nama_jurusan); ?> · SMKN 2 Jember</title>
...
<nav class="navbar">
    <a href="<?php echo e(route('landing.home')); ?>" class="nav-brand">
    ...
    <a href="<?php echo e(url()->previous()); ?>" class="nav-back">← Kembali</a>
</nav>
...
<section class="hero">
    ...
    <div class="container">
        ...
        <h1 class="hero-title"><?php echo e($jurusan->nama_jurusan); ?></h1>
        <p class="hero-desc">
            <?php echo e($info->deskripsi ?? 'Temukan informasi lengkap tentang program keahlian ini — mulai dari fasilitas, prospek karir, hingga artikel terbaru dari jurusan.'); ?>

        </p>
        <?php if(auth()->guard()->guest()): ?>
        <a href="<?php echo e(route('register')); ?>" class="hero-cta">
            ✨ Ikuti Tes Jurusan
        </a>
        <?php endif; ?>
    </div>
...
<div class="main">
    <div class="container">
        ...
        <div class="section" id="fasilitas">
            ...
            <?php if($info && $info->fasilitas): ?>
                <div class="fasilitas-box"><?php echo e($info->fasilitas); ?></div>
            <?php else: ?>
        ...
        <div class="section" id="prospek">
            ...
            <div class="prospek-grid">
                <div class="prospek-card">
                    ...
                    <?php if($prospekUmum->count()): ?>
                        <div class="prospek-list">
                            <?php $__currentLoopData = $prospekUmum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="prospek-tag umum"><?php echo e($p->isi); ?></span>
                ...
                <div class="prospek-card">
                    ...
                    <?php if($prospekAlumni->count()): ?>
                        <div class="prospek-list">
                            <?php $__currentLoopData = $prospekAlumni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="prospek-tag alumni"><?php echo e($p->isi); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php else: ?>
                        <div style="font-size:13px;color:#94a3b8;font-style:italic;">Belum ada data.</div>
            ...
            <div class="artikel-grid">
                ...
                <div class="artikel-card">
                    <?php if($a->gambarUpload): ?>
                        <img class="artikel-img" src="<?php echo e(Storage::url($a->gambarUpload->storage_path)); ?>" alt="<?php echo e($a->judul); ?>">
                    <?php else: ?>
                        <div class="artikel-img-placeholder">📄</div>
                    <?php endif; ?>
                    <div class="artikel-body">
                        <div class="artikel-date">📅 <?php echo e($a->created_at->translatedFormat('d M Y')); ?></div>
                        <div class="artikel-title"><?php echo e($a->judul); ?></div>
                        <?php if($a->fileUpload): ?>
                            <div class="artikel-file">📎 <?php echo e($a->fileUpload->file_name); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
...
</html><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/landingpage/jurusan-detail.blade.php ENDPATH**/ ?>