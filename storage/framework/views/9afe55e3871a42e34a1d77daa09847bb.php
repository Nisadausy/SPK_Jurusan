...
<?php $__env->startSection('title',"Edit Info · {$jurusan->nama_jurusan}"); ?>
<?php $__env->startSection('page-title','Info Jurusan'); ?>
<?php $__env->startSection('page-sub','FR-BK-08/09 · Kelola fasilitas & prospek kerja jurusan kamu'); ?>
...
<form method="POST" action="<?php echo e(route('bk.infojurusan.update', $jurusan->id)); ?>">
    ...
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:24px;margin-bottom:16px;box-shadow:0 1px 3px rgba(0,0,0,.05);">
        ...
        <textarea name="fasilitas" rows="4"
            ...
            onblur="this.style.borderColor='#e2e8f0';this.style.background='#f8fafc'"><?php echo e(old('fasilitas', $info->fasilitas ?? '')); ?></textarea>
    </div>
    ...
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:24px;margin-bottom:16px;box-shadow:0 1px 3px rgba(0,0,0,.05);">
        ...
        <div id="prospek-umum">
            <?php $__empty_1 = true; $__currentLoopData = $prospekUmum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div style="display:flex;gap:8px;margin-bottom:8px;">
                <input name="prospek_umum[]" value="<?php echo e($p); ?>"
    ...
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:24px;margin-bottom:20px;box-shadow:0 1px 3px rgba(0,0,0,.05);">
        ...
        <div id="prospek-alumni">
            <?php $__empty_1 = true; $__currentLoopData = $prospekAlumni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div style="display:flex;gap:8px;margin-bottom:8px;">
                <input name="prospek_alumni[]" value="<?php echo e($p); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.bk', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/bk/infojurusan/edit.blade.php ENDPATH**/ ?>