...
<?php $__env->startSection('title',"Info · {$jurusan->nama_jurusan}"); ?>
<?php $__env->startSection('page-title','Info Jurusan'); ?>
<?php $__env->startSection('page-sub','FR-BK-08/09 · Informasi jurusan yang kamu kelola'); ?>
...
<div style="background:linear-gradient(135deg,var(--primary-dark),var(--primary));border-radius:14px;padding:20px 24px;margin-bottom:20px;display:flex;align-items:center;gap:16px;">
    ...
    <div style="flex:1;">
        ...
        <div style="font-family:'Syne',sans-serif;font-size:18px;font-weight:800;color:#fff;"><?php echo e($jurusan->nama_jurusan); ?></div>
    </div>
    <a href="<?php echo e(route('bk.infojurusan.edit', $jurusan->id)); ?>"
...
<div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:24px;margin-bottom:16px;box-shadow:0 1px 3px rgba(0,0,0,.05);">
    ...
    <?php if($info && $info->fasilitas): ?>
        <p style="font-size:13px;color:#374151;line-height:1.7;white-space:pre-line;"><?php echo e($info->fasilitas); ?></p>
    <?php else: ?>
        <div style="font-size:13px;color:#94a3b8;font-style:italic;">Belum ada informasi fasilitas. <a href="<?php echo e(route('bk.infojurusan.edit', $jurusan->id)); ?>" style="color:#2563eb;">Tambahkan sekarang →</a></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.bk', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/bk/infojurusan/show.blade.php ENDPATH**/ ?>