...
<?php $__env->startSection('page-title','Ubah Password'); ?>
<?php $__env->startSection('page-sub','FR-BK-02 · Keamanan akun'); ?>
...
<div class="card" style="padding:24px;max-width:460px;">
    ...
    <form method="POST" action="<?php echo e(route('bk.password.update')); ?>">
...
<?php echo $__env->make('layouts.bk', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/bk/password.blade.php ENDPATH**/ ?>