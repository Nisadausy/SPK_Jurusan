...
<?php $__env->startSection('title', 'SPK Pemilihan Jurusan - SMK Negeri 2 Jember'); ?>
    ...
    <div class="carousel-container">
                ...
                <div class="flex-1 text-white">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('siswa.tes.index')); ?>" class="hero-cta-primary px-7 py-3 rounded-xl text-sm inline-block">
                                Mulai Seleksi Jurusan →
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="hero-cta-primary px-7 py-3 rounded-xl text-sm inline-block">
                                Login untuk Mulai →
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="hero-cta-secondary px-7 py-3 rounded-xl text-sm inline-block">
                                Daftar Akun
                            </a>
                        <?php endif; ?>
                    </div>
        ...
        <div class="carousel-slide">
            <div class="max-w-7xl mx-auto px-6 py-14 md:py-20 text-center relative z-10">
                ...
                <a href="<?php echo e(route('register')); ?>" class="hero-cta-primary px-8 py-3.5 rounded-xl text-sm inline-block font-bold">
                    Registrasi Sekarang !
                </a>
<?php endif; ?>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
            ...
            <div class="py-5 px-6 text-center">
                <div class="text-2xl mb-1"><?php echo e($stat[2]); ?></div>
                <div class="text-2xl font-extrabold text-blue-900 leading-tight"><?php echo e($stat[0]); ?></div>
                <div class="text-xs text-gray-500 mt-0.5"><?php echo e($stat[1]); ?></div>
            </div>
...
<section id="program-keahlian" class="py-14 px-4 bg-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-5">
           ...
           <?php $__currentLoopData = $jurusans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="jurusan-card shadow-sm fade-in p-5">
                ...
                <a href="<?php echo e(route('jurusan.show', $j->id)); ?>">Lihat Detail →</a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="text-center mt-10">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('siswa.tes.index')); ?>" class="inline-block bg-blue-800 hover:bg-blue-900 text-white font-bold px-8 py-3 rounded-xl text-sm transition-colors shadow-md">
                    Mulai Seleksi Jurusan dengan SPK →
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="inline-block bg-blue-800 hover:bg-blue-900 text-white font-bold px-8 py-3 rounded-xl text-sm transition-colors shadow-md">
                    Login untuk Mulai →
                </a>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/landingpage/home.blade.php ENDPATH**/ ?>