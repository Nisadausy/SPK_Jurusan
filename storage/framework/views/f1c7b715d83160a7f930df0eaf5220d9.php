    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="email@smkn2jember.sch.id" required autofocus>
            </div>
            <div class="form-group">
            ...
            <div class="register-link">Belum punya akun? <a href="<?php echo e(route('register')); ?>">Daftar</a></div>
        </form>
    </div>
</div>
</body>
</html><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/auth/login.blade.php ENDPATH**/ ?>