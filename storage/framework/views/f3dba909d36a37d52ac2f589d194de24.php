...
<?php $__env->startSection('title','Statistik Jurusan'); ?>
<?php $__env->startSection('page-title','Statistik Jurusan'); ?>
<?php $__env->startSection('page-sub','FR-BK-06 · Rekap & grafik peminat jurusan'); ?>
...
<script>
const jLabel = <?php echo json_encode($peminatJurusan->map(fn($r) => $r->jurusan->nama ?? '?')); ?>;
const jData  = <?php echo json_encode($peminatJurusan->pluck('total')); ?>;
...
const klabel = <?php echo json_encode($kesesuaian->pluck('nama_jurusan')); ?>;
const sesuai = <?php echo json_encode($kesesuaian->pluck('sesuai')); ?>;
const beda   = <?php echo json_encode($kesesuaian->pluck('berbeda')); ?>;
...
<?php echo $__env->make('layouts.bk', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SPK Jurusan SMK\4 Backup\SPK_Jurusan\SPK_Jurusan_Mapel Dipisah\resources\views/pages/bk/statistik.blade.php ENDPATH**/ ?>